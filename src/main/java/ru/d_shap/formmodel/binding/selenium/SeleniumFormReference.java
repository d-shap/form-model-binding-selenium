...
/**
 * Selenium form reference.
 *
 * @author Dmitry Shapovalov
 */
public final class SeleniumFormReference extends BindedFormReference<SeleniumElement, SeleniumFormReference, Element> {

    SeleniumFormReference(final FormReferenceDefinition formReferenceDefinition) {
